package com.power.recyclingcompany.utils;
...
public class SendSmsTimerUtils extends CountDownTimer {//验证码倒计时的工具类
    ...
    * */
    ...
    public void onTick(long millisUntilFinished) {
        ...
        mTextView.setTextColor(App.getInstance().getResources().getColor(downInterval));
    ...
    public void onFinish() {
        ...
        mTextView.setTextColor(App.getInstance().getResources().getColor(R.color.colorPrimary));
    }
}
