...
/**
 * @author power
 * @date 2018/6/7 上午9:56
 * @description:
 */
public class RigistSecActivity extends BaseActivity<RigistSecContract, RigistSecPresenter> implements RigistSecContract {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rigist_sec);
        ButterKnife.bind(this);
        initView();
    }

    private void initView() {
        titleContentTv.setText("资料审核");
    }

    @Override
    protected RigistSecPresenter createPresenter() {
        return new RigistSecPresenter();
    }

    @OnClick({R.id.tv_verify, R.id.iv_camera, R.id.tv_commit})
