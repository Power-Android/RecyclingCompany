...
/**
 * @author power
 * @date 2018-06-28 09:05:32
 * @description:
 */
public class PersonInfoActivity extends BaseActivity<PersonInfoContract, PersonInfoPresenter> {
    ...
    RelativeLayout farenRl;
    @BindView(R.id.gongsi_address_tv)
    TextView gongsiAddressTv;
    @BindView(R.id.gongsi_address_rl)
    RelativeLayout gongsiAddressRl;
...
//                .previewEggs(true)//预览图片时 是否增强左右滑动图片体验(图片滑动一半即可看到上一张是否选中)
    ...
    @OnClick({R.id.title_back_iv, R.id.face_rl, R.id.company_name_rl, R.id.faren_rl, R.id.gongsi_address_rl})
